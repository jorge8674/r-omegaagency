...
const TYPE_ICON: Record<string, React.ReactNode> = {
  near_limit: <Lightbulb className="h-5 w-5 text-primary" />,
  onboarding: <AlertTriangle className="h-5 w-5 text-[hsl(var(--warning))]" />,
    ...
    <Card className="border-border/30 bg-card/60">
      <CardHeader>
        <CardTitle className="text-base font-display flex items-center gap-2">
          <Lightbulb className="h-5 w-5 text-primary" /> Oportunidades
        </CardTitle>
      </CardHeader>
      <CardContent>
